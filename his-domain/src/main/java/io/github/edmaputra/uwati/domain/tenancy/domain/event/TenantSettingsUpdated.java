...
public record TenantSettingsUpdated(
	...
	public static TenantSettingsUpdated of(
			TenantId tenantId,
			List<TenantSetting> previousSettings,
			List<TenantSetting> updatedSettings) {
		return new TenantSettingsUpdated(
				tenantId,
				List.copyOf(previousSettings),
				List.copyOf(updatedSettings),
				Instant.now());
	}

	public static TenantSettingsUpdated of(TenantId tenantId, List<TenantSetting> updatedSettings) {
		return of(tenantId, List.of(), updatedSettings);
	}
}
