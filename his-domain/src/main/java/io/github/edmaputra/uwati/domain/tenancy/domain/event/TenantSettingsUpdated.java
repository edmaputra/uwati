...
public record TenantSettingsUpdated(
	...
	public static TenantSettingsUpdated of(TenantId tenantId, List<TenantSetting> updatedSettings,
			List<SettingChange> changes, String actor, String correlationId) {
		return new TenantSettingsUpdated(tenantId, List.copyOf(updatedSettings),
				List.copyOf(changes), actor, correlationId, Instant.now());
	}
}
